...
namespace vFashionWEB.Controllers
{
    public class GioHangController : Controller
    {
        ...
        public ActionResult DatHang(string shipName, string shipTel, string shipEmail, string shipAddress, string payment="")
        {
            ...
            try
            {
                // Your code that causes the exception goes here
            }
            ...
            new MailHelper().SendMail(shipEmail, "Đơn hàng mới từ Nguyễn Trọng Sneaker", content);
            new MailHelper().SendMail(toEmail, "Đơn hàng mới từ Nguyễn Trọng Sneaker", content);
            db.SaveChanges();
            if (payment == "paypal")
            {
